...
window.CALC_CATS=[
  ...
  {key:"tools", name:"사진·글자 도구",emoji:"🛠️", path:"/tools/",  desc:"브라우저 안에서 바로 처리하는 도구"}
];
window.CALCS=[
  /* 돈·금융 */
  ...
  {id:"airport-parking",cat:"life",emoji:"✈️",name:"공항 주차비 계산기",path:"/life/airport-parking/",status:"soon",
  ...
  /* 도구 */
  {id:"char-count",cat:"tools",emoji:"🔤",name:"글자수 세기",path:"/tools/char-count/",status:"live",popular:true,isNew:true,
   desc:"공백 포함·제외, 바이트, 원고지",kw:"글자수 세기 공백포함 바이트 자소서 원고지"},
  {id:"id-photo",cat:"tools",emoji:"🪪",name:"증명·여권사진 리사이저",path:"/tools/id-photo/",status:"soon",
   desc:"규격에 맞게 자르고 저장",kw:"증명사진 여권사진 규격 리사이즈 3.5x4.5"},
  {id:"image-compress",cat:"tools",emoji:"🗜️",name:"이미지 용량 줄이기",path:"/tools/image-compress/",status:"soon",
   desc:"제출 용량 제한 맞추기",kw:"이미지 압축 용량 줄이기 사진 크기"},
  {id:"unit",cat:"tools",emoji:"📏",name:"단위 변환기",path:"/tools/unit/",status:"soon",
   desc:"길이·무게·온도·부피 변환",kw:"단위변환 길이 무게 온도 부피"},
  {id:"qr",cat:"tools",emoji:"🔳",name:"QR코드 생성기",path:"/tools/qr/",status:"soon",
   desc:"URL·텍스트·와이파이 QR",kw:"QR코드 생성 큐알"}
];
